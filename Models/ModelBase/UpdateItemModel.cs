...
{
    public abstract class UpdateItemModel<Entity> : BindableBase
    {
        private UpdateItemModel() { }
        protected UpdateItemModel(Entity item, bool newRecord, string itemName) { Item = item; NewRecord = newRecord; ItemName = itemName; }
        ...
        public string TitleText { get { return (NewRecord ? "New " : "Modify ") + ItemName; } }
